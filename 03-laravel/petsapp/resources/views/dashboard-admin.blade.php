...
@section('content')
    ...
    <h1 class="text-6xl text-white font-bold mb-10 pb-2 border-b-2">Welcome: Administrador</h1>
    <div class="stats shadow">
        ...
        <div class="btn bg-cyan-800 text-white rounded-full mt-4" href="{{ url('pets') }}">
            <div class="stat-figure text-secondary">
