...
@auth
    <ul class="flex items-center gap-2">
        ...
        <li>
         <span class="badge badge-text-white border-cyan-800 bg-cyan-800">Admin: {{ Auth::user()->fullname}}</span>
        </li>
            ...
            <details class="dropdown dropdown-end">
              <summary class="btn text-white bg-[#fff0] border-[#fff0] shadow-none">
                ...
                <ul class="menu dropdown-content bg-cyan-600 rounded-box z-1 w-52 p-2 shadow-sm">
                    ...
                    <li>
                        <a href="{{ url('pets') }}">
                            <svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 63.445 63.445" xml:space="preserve"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
