...
@section('content')
    ...
    <ul class="menu gap-1 mb-8 sm:menu-horizontal bg-base-200 rounded-box">
        ...
        <li><a href="" class="btn btn-neutral btn-outline">Export PDF</a></li>
        <li><a href="" class="btn btn-neutral btn-outline">Export Excel</a></li>
    </ul>
                ...
                <tr>
                    @foreach ($users as $user)
                        ...
                        <th>
                            ...
                            <a class="btn btn-outline btn-square btn-error btn-xs" href="{{ url('users/'.$user->id) }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-4">
                                    <path stroke-linecap="round" stroke-linejoin="round"
